...
cdef extern from 'cudarray/nnet/pool_b01.hpp' namespace 'cudarray':

    void max_pool_b01[T](const T* imgs, int n_imgs, int img_h, int img_w,
        int win_h, int win_w, int pad_y, int pad_x, int stride_y, int stride_x,
        T* out, int* mask)

    void max_pool_b01_bprob[T](const T* out_d, const int* mask, int n_imgs,
